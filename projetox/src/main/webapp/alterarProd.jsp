                            ...
                            <table>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 inputGroupContainer">
                                        <div class="input-group">
                                            ...
                                            <input name="nome" placeholder="Nome" value='<%=request.getAttribute("nome")%>' class="form-control" type="text">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 inputGroupContainer">
                                        <div class="input-group">
                                            ...
                                            <input name="codigo" placeholder="Codigo" class="form-control"  disabled type="text">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-4 selectContainer">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                                            <select disabled name="filial" class="form-control selectpicker">
